...
class DeleteUser(QDialog):
    """Класс - выбора контакта для удаления."""
    ...
    def all_users_fill(self):
        """
        Функция заполняющая список пользователей
        :return:
        """
        self.selector.addItems([item[0] for item in self.database.users_list()])

    def remove_user(self):
        """ Функция обрабатывающая удаления пользователя """
        ...
        # Рассылаем клиентам сообщение о необходимости обновления списков
